...
//     if (!confirm("Are you sure you want to cleanup all expired announcements?")) return;
...
// export default AnnouncementPage; handleFormChange("message", e.target.value)}
//                   style={styles.formTextarea}
//                   rows="4"
//                   required
//                 />
...
//           <div style={styles.modal}>
//             <div style={styles.modalHeader}>
//               <h3 style={styles.modalTitle}>Edit Announcement</h3>
//               <button
//                 style={styles.closeBtn}
//                 onClick={() => {
//                   setShowEditModal(false);
...
//               </button>
//             </div>
//             <form onSubmit={handleUpdateAnnouncement} style={styles.modalForm}>
//               <div style={styles.formGroup}>
//                 <label style={styles.formLabel}>Title</label>
//                 <input
//                   type="text"
